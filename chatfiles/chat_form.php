...
<!--UI for the the user to select smilies and to write chat messages-->
 ...
 &nbsp;&nbsp; 
  ...
  <input type="submit" value="<?php echo $this->lsite['chat']; ?>" id="submit"/></input>
  <style>input.hidden {visibility: hidden;}</style>
  <input class="hidden" type="button" onclick="location.href = 'newchatroom.php';" /></input>  <!--button to create new chatroom-->
  </form>
  <div id="logoutchat" onclick="exit_chat()"><?php echo $this->lsite['logoutchat']; ?></div>  <!--to logout from chat-->
 </div>
</form>
