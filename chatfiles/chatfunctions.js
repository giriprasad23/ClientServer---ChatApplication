...
//java script for chatfunctions to perform different tasks
...
var beepfile = 'beep.wav';                      // the name of WAV file used for beep sound
...
function enterChat() {
  ...
  chatuserset = 1;
    ...
    var dispuser = user + " joined this chat room";
    var  send_chat = "adchat="+dispuser+"&chatuser="+"";
...
function exit_chat()
{
window.location = "logout_handle.php";

//Display that the user left the chat
 
var user = document.getElementById('chatuser').value;
    var dispuser = user + " left this chat room";
    var  send_chat = "adchat="+dispuser+"&chatuser="+"";
     ajxsend = 1;         // Ajax busy now 
